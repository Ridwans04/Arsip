              ...
              @if (Auth::user()->level == 'Admin')
                <div class="card-header border-bottom p-1">
                    <div class="head-label">
                        <button class="btn btn-relief-success round waves-effect" type="button" onclick="window.location.href='/disposisi/create'">
                            <span>
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <div class="demo-inline-spacing" role="group" style="">
                                    <button onclick="window.location.href='/disposisi/{{$d->id}}/edit'" data-bs-toggle="tooltip" data-bs-placement="right"
                                    title="Edit disposisi" type="button" class="btn btn-icon btn-success ">
                                      <i data-feather="edit"></i>        
                                    </button>
                                    <form id="hapus_{{$d->id}}" action="/surat/{{$d->id}}" method="POST">
                                      @csrf
                                      @method('delete')
                                      <button type="button" class="btn btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="right"
                                                    title="Hapus Disposisi" onclick="notif_delete({{$d->id}})" value="delete">
                                          ...
                                          <div class="modal-dialog modal-dialog-scrollable">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalScrollableTitle">Dokumen Disposisi</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                              </div>
                                              <div class="modal-body">
                                               {{-- ambil gambar dari public --}}
                                                <img class="img-fluid" alt="" src="{{ asset('/disposisi/'.$d->institusi.'/'.$d->surat_id.'/'.$d->dokumen)}}" width="100%">
