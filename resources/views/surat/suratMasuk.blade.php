                            ...
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="nomor" class="form-control"
                                            placeholder="Masukkan Nomor dokumen" value="{{ $params['nomor_surat'] ?? '' }}"
                                            name="nomor_surat" />
                                    </div>
                                </div>
                                <!-- JENIS SURAT -->
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="ket" class="form-control" name="tujuan_surat"
                                            value="{{ $params['keterangan'] ?? '' }}" placeholder="Tulis Disini" />
                                    </div>
                                </div>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="demo-inline-spacing mb-2">
                                                        ...
                                                        @if (empty($sm->disposisi_id))
                                                            <a href="../disposisi/{{ $sm->id }}/suratDisposisi"
                                                                target="_blank" data-bs-toggle="tooltip"
                                                                data-bs-placement="right" title="Buat Disposisi"
                                                                class="btn btn-icon btn-info"><i
                                                                    data-feather="clipboard"></i></a>
                                                        @else
                                                            <a href="../disposisi/{{ $sm->disposisi_id }}/edit?read_only=1"
                                                                data-bs-toggle="tooltip" data-bs-placement="right"
                                                                title="Lihat Disposisi" target="_blank"
                                                                class="btn btn-icon btn-info"><i
                                                                    data-feather="inbox"></i></a>
                                                        @endif

                                                        @if (empty($sm->arsip_id))
                                                            <a href="../arsip/{{ $sm->id }}/suratArsip"
                                                                data-bs-toggle="tooltip" data-bs-placement="right"
                                                                title="Buat Arsip" target="_blank"
                                                                class="btn btn-icon btn-info"><i
                                                                    data-feather="folder-plus"></i></a>
                                                        @else
                                                            <a href="../arsip/{{ $sm->arsip_id }}/edit?read_only=1"
                                                                data-bs-toggle="tooltip" data-bs-placement="right"
                                            ...
                                            @else
                                                <td>
                                                    <a href="{{ url('surat/viewpdf', $sm->id) }}"
                                                        data-bs-toggle="tooltip" data-bs-placement="right"
                                                        title="Lihat Surat" target="_blank"
                                                        class="btn btn-icon btn-success"><i data-feather="file"></i></a>
                                                </td>
                                            @endif
                                                ...
                                                <td>
                                                    ...
                                                    <div class="demo-inline-spacing mb-2">
                                                        ...
                                                        @if (empty($sm->disposisi_id))
                                                            <a href="../disposisi/{{ $sm->id }}/suratDisposisi"
                                                                data-bs-toggle="tooltip" data-bs-placement="right"
                                                                title="Buat Disposisi" target="_blank"
                                                                class="btn btn-icon btn-info"><i
                                                        ...
                                                        @if (empty($sm->arsip_id))
                                                            <a href="../arsip/{{ $sm->id }}/suratArsip"
                                                                target="_blank" data-bs-toggle="tooltip"
                                                                data-bs-placement="right" title="Buat Arsip"
                                                                class="btn btn-icon btn-info"><i
                                                                    data-feather="folder-plus"></i></a>
                                                        @else
                                                            <a href="../arsip/{{ $sm->arsip_id }}/edit?read_only=1"
