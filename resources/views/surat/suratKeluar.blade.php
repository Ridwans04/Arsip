                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="demo-inline-spacing mb-2">
                                                    <button onclick="window.location.href='/surat/{{$sk->id}}/edit'" data-bs-toggle="tooltip" data-bs-placement="right"
                                                    title="Edit Surat" type="button" class="btn btn-icon btn-success ">
                                                        <i data-feather="edit"></i></button>
                                                    <a href="{{url ('surat/viewpdf', $sk->id)}}" data-bs-toggle="tooltip" data-bs-placement="right"
                                                    title="Lihat Surat" target="_blank" class="btn btn-icon btn-success"><i data-feather="file-plus"></i></a>
                                                    <form id="hapus_{{$sk->id}}" action="/surat/{{ $sk->id }}" method="POST">
                                                      @csrf
                                                      @method('delete')
                                                      <button type="button" class="btn btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="right"
                                                        title="Hapus Surat" onclick="notif_delete({{$sk->id}})" value="delete">
                                                          <i data-feather="trash"></i>
                                                      </button>
                                                   </form>
                                                    @if(empty($sk->ekspedisi_id))
                                                        <a href="../ekspedisi/{{$sk->id}}/suratEkspedisi" data-bs-toggle="tooltip" data-bs-placement="right"
                                                    title="Buat Ekspedisi" target="_blank" class="btn btn-icon btn-info" ><i data-feather="book-open"></i></a>
                                                        
                                                    @else
                                                        <a href="../ekspedisi/{{$sk->ekspedisi_id}}/edit?read_only=1" data-bs-toggle="tooltip" data-bs-placement="right"
                                                    title="Lihat Ekspedisi" target="_blank" class="btn btn-icon btn-info" ><i data-feather="layout"></i></a>
                                                        
                                                    @endif

                                                    @if(empty($sk->arsip_id))
                                                        <a href="../arsip/{{$sk->id}}/suratArsip" data-bs-toggle="tooltip" data-bs-placement="right"
                                                    title="Buat Arsip"  target="_blank" class="btn btn-icon btn-info"><i data-feather="folder-plus"></i></a>
                                                    @else
                                                        <a href="../arsip/{{$sk->arsip_id}}/edit?read_only=1" data-bs-toggle="tooltip" data-bs-placement="right"
                                            ...
                                            <td>
                                            <a href="{{url ('surat/viewpdf', $sk->id)}}" data-bs-toggle="tooltip" data-bs-placement="right"
                                                    title="Lihat Surat" target="_blank" class="btn btn-icon btn-secondary"><i data-feather="file"></i></a>
                                            </td>
                                            @endif
